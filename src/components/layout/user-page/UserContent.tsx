...
function UserContent({
  ...
  return (
    <div className={`lg:p-10 p-3 ${!edit && "mt-12"}`}>
      <div className="flex">
      ...
      <div
        className={`bg-neutral-50 flex  gap-x-12  border-white border-2 shadow-card h-80 ${
          edit ? "rounded-b-xxl" : "rounded-xxl"
        } text-primary-950 font-semibold p-4 xl2:p-8 z-40`}
      >
        <div className="lg:w-1/5 sm:w-auto lg:block hidden ">
          <UserStatus user={user} edit={edit} />
        </div>
